...
# SET THE DESIRED ORGANISM HERE   #See all annotations available here:  https://bioconductor.org/packages/release/BiocViews.html#___OrgDb
...
#emapplot(gse, showCategory = 10)  #ERROR
